...
const InformedPoster = () => {
    ...
    return (
        <div data-aos="fade-left" data-aos-duration="1500" className="w-full py-6 flex justify-center overflow-hidden items-center bg-informedPoster bg-cover bg-center bg-no-repeat lg:px-44 sm:px-16 px-8">
