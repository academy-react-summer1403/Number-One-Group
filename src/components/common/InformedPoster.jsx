...
const InformedPoster = () => {
    ...
    return (
        <div className="w-full h-[340px] sm:h-auto py-6 flex justify-center overflow-hidden items-start sm:items-center informedPoster bg-cover bg-center bg-no-repeat lg:px-44 sm:px-16 px-8">
            ...
            <div className="w-[700px] h-fit flex flex-wrap gap-y-6 mt-8">
                ...
                <div className="w-full h-14 flex flex-wrap justify-center xl:justify-start sm:flex-nowrap gap-y-6 gap-x-2">
                    <input className="w-full xl:w-2/3 rounded-full px-4 py-3 bg-[#4A44D1]" placeholder={t("informedPlaceholder")} type="email" />
                    <CustomButton text={t("informedBtn")} vType="button" vStyle="yellow" style="h-full" arrowColor="#000" />
                </div>
            </div>
        </div>
    )
