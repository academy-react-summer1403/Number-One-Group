...
const UserCourseStatus = ({ name, amount, Icon, description, href }) => {
    ...
    return (
        <Link to={href} className='w-2/5 lg:w-44 min-w-52 h-20 flex bg-LightLavender rounded-md heroSection_box_shadow py-2 px-4 relative'>
            <div className="w-full flex flex-wrap">
                ...
                <span className='w-full mediumStyle_text text-nowrap'>{description}</span>
            </div>
